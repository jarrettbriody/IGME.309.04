...
class Application
{
	...
	MyMesh** cubes = new MyMesh*[46];
	vector3 translations[46] = {
									vector3(-5.0f, -2.5f, 3.0f), 
									vector3(-5.0f, -1.5f, 3.0f), 
									vector3(-5.0f, -0.5f, 3.0f), 
									vector3(-4.0f, -0.5f, 3.0f), 
									vector3(-4.0f, 0.5f, 3.0f), 
									vector3(-3.0f, -2.5f, 3.0f),
									vector3(-3.0f, -1.5f, 3.0f),
									vector3(-3.0f, -0.5f, 3.0f),
									vector3(-3.0f, 0.5f, 3.0f),
									vector3(-3.0f, 1.5f, 3.0f),
									vector3(-3.0f, 3.5f, 3.0f),
									vector3(-2.0f, -3.5f, 3.0f),
									vector3(-2.0f, -1.5f, 3.0f),
									vector3(-2.0f, -0.5f, 3.0f),
									vector3(-2.0f, 1.5f, 3.0f),
									vector3(-2.0f, 2.5f, 3.0f),
									vector3(-1.0f, -3.5f, 3.0f),
									vector3(-1.0f, -1.5f, 3.0f),
